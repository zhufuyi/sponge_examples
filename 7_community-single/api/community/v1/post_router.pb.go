...
type PostServiceLogicer interface {
	...
	ListByIDs(ctx context.Context, req *ListPostByIDsRequest) (*ListPostByIDsReply, error)
...
func (r *postServiceRouter) register() {
	...
	r.iRouter.Handle("POST", "/api/v1/post/list/ids", r.withMiddleware("POST", "/api/v1/post/list/ids", r.ListByIDs_2)...)
...
func (r *postServiceRouter) ListByIDs_2(c *gin.Context) {
	req := &ListPostByIDsRequest{}
	var err error
