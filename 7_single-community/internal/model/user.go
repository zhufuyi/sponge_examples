...
type User struct {
	...
	NickName string    `gorm:"column:nick_name;type:varchar(50);NOT NULL" json:"nick_name"` // 用户昵称
	...
	LoginAt  time.Time `gorm:"column:login_at;type:datetime" json:"login_at"`               // 登录时间
	LoginIP  string    `gorm:"column:login_ip;type:char(16)" json:"login_ip"`               // 登录ip
