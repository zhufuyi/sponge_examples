...
// Validate checks the field values on ChangeRegisterReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *ChangeRegisterReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ChangeRegisterReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ChangeRegisterReplyMultiError, or nil if none found.
func (m *ChangeRegisterReply) ValidateAll() error {
	return m.validate(true)
}

func (m *ChangeRegisterReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return ChangeRegisterReplyMultiError(errors)
	}

	return nil
}

// ChangeRegisterReplyMultiError is an error wrapping multiple validation
// errors returned by ChangeRegisterReply.ValidateAll() if the designated
// constraints aren't met.
type ChangeRegisterReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ChangeRegisterReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ChangeRegisterReplyMultiError) AllErrors() []error { return m }

// ChangeRegisterReplyValidationError is the validation error returned by
// ChangeRegisterReply.Validate if the designated constraints aren't met.
type ChangeRegisterReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ChangeRegisterReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ChangeRegisterReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ChangeRegisterReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ChangeRegisterReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ChangeRegisterReplyValidationError) ErrorName() string {
	return "ChangeRegisterReplyValidationError"
}

// Error satisfies the builtin error interface
func (e ChangeRegisterReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sChangeRegisterReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ChangeRegisterReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ChangeRegisterReplyValidationError{}
