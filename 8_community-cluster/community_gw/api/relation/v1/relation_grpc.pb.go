...
func (c *relationServiceClient) Follow(ctx context.Context, in *FollowRequest, opts ...grpc.CallOption) (*FollowReply, error) {
	out := new(FollowReply)
	err := c.cc.Invoke(ctx, "/api.relation.v1.RelationService/Follow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationServiceClient) Unfollow(ctx context.Context, in *UnfollowRequest, opts ...grpc.CallOption) (*UnfollowReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.relation.v1.RelationService/Unfollow", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationServiceClient) ListFollowing(ctx context.Context, in *ListFollowingRequest, opts ...grpc.CallOption) (*ListFollowingReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.relation.v1.RelationService/ListFollowing", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationServiceClient) ListFollower(ctx context.Context, in *ListFollowerRequest, opts ...grpc.CallOption) (*ListFollowerReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.relation.v1.RelationService/ListFollower", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *relationServiceClient) BatchGetRelation(ctx context.Context, in *BatchGetRelationRequest, opts ...grpc.CallOption) (*BatchGetRelationReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.relation.v1.RelationService/BatchGetRelation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RelationService_Follow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.relation.v1.RelationService/Follow",
	}
...
func _RelationService_Unfollow_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.relation.v1.RelationService/Unfollow",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RelationService_ListFollowing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.relation.v1.RelationService/ListFollowing",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RelationService_ListFollower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.relation.v1.RelationService/ListFollower",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RelationService_BatchGetRelation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.relation.v1.RelationService/BatchGetRelation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RelationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.relation.v1.RelationService",
