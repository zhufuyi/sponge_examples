...
func Test_commentContentDao_GetByID(t *testing.T) {
	...
	_, err := d.IDao.(CommentContentDao).GetByID(d.Ctx, testData.ID)
	if err != nil {
		t.Fatal(err)
	}
...
func Test_commentContentDao_GetByCondition(t *testing.T) {
	d := newCommentContentDao()
	defer d.Close()
	testData := d.TestData.(*model.CommentContent)
	...
	_, err := d.IDao.(CommentContentDao).GetByCondition(d.Ctx, &query.Conditions{
...
func Test_commentContentDao_DeleteByTx(t *testing.T) {
	...
	err := d.IDao.(CommentContentDao).DeleteByTx(d.Ctx, d.DB, testData.ID)
	if err != nil {
		t.Fatal(err)
	}
}
