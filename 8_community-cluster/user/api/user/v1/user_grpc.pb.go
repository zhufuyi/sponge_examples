...
type UserServiceClient interface {
	...
	// 检查登录状态
	CheckLogin(ctx context.Context, in *CheckLoginRequest, opts ...grpc.CallOption) (*CheckLoginReply, error)
	// 删除用户
...
func (c *userServiceClient) SendEmailVerifyCode(ctx context.Context, in *SendEmailVerifyCodeRequest, opts ...grpc.CallOption) (*SendEmailVerifyCodeReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.user.v1.UserService/SendEmailVerifyCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) CheckLogin(ctx context.Context, in *CheckLoginRequest, opts ...grpc.CallOption) (*CheckLoginReply, error) {
	out := new(CheckLoginReply)
	err := c.cc.Invoke(ctx, "/api.user.v1.UserService/CheckLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) DeleteByID(ctx context.Context, in *DeleteUserByIDRequest, opts ...grpc.CallOption) (*DeleteUserByIDReply, error) {
	out := new(DeleteUserByIDReply)
	err := c.cc.Invoke(ctx, "/api.user.v1.UserService/DeleteByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) UpdateByID(ctx context.Context, in *UpdateUserByIDRequest, opts ...grpc.CallOption) (*UpdateUserByIDReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.user.v1.UserService/UpdateByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetByID(ctx context.Context, in *GetUserByIDRequest, opts ...grpc.CallOption) (*GetUserByIDReply, error) {
	...
	err := c.cc.Invoke(ctx, "/api.user.v1.UserService/GetByID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// 检查登录状态
	CheckLogin(context.Context, *CheckLoginRequest) (*CheckLoginReply, error)
	// 删除用户
...
func (UnimplementedUserServiceServer) CheckLogin(context.Context, *CheckLoginRequest) (*CheckLoginReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckLogin not implemented")
}
func (UnimplementedUserServiceServer) DeleteByID(context.Context, *DeleteUserByIDRequest) (*DeleteUserByIDReply, error) {
...
func _UserService_SendEmailVerifyCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.UserService/SendEmailVerifyCode",
	}
...
func _UserService_CheckLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.UserService/CheckLogin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_DeleteByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.UserService/DeleteByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).DeleteByID(ctx, req.(*DeleteUserByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_UpdateByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.UserService/UpdateByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.user.v1.UserService/GetByID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
