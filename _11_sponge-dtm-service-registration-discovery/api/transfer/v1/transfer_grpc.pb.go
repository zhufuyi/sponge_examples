...
const (
	Transfer_Transfer_FullMethodName = "/api.transfer.v1.transfer/Transfer"
	Transfer_TransOut_FullMethodName = "/api.transfer.v1.transfer/TransOut"
	Transfer_TransIn_FullMethodName  = "/api.transfer.v1.transfer/TransIn"
)
...
func (c *transferClient) Transfer(ctx context.Context, in *TransferRequest, opts ...grpc.CallOption) (*TransferReply, error) {
	...
	err := c.cc.Invoke(ctx, Transfer_Transfer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferClient) TransOut(ctx context.Context, in *TransOutRequest, opts ...grpc.CallOption) (*TransOutReply, error) {
	...
	err := c.cc.Invoke(ctx, Transfer_TransOut_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferClient) TransIn(ctx context.Context, in *TransInRequest, opts ...grpc.CallOption) (*TransInReply, error) {
	...
	err := c.cc.Invoke(ctx, Transfer_TransIn_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Transfer_TransOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Transfer_TransOut_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Transfer_TransIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Transfer_TransIn_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
