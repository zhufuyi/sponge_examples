...
func eshopMiddlewares(c *middlewareConfig) {
	...
	//c.setSinglePath("GET", "/api/v1/user/list", middleware.Auth())
	//c.setSinglePath("POST", "/api/v1/product", middleware.Auth())
	//c.setSinglePath("GET", "/api/v1/product/list", middleware.Auth())
