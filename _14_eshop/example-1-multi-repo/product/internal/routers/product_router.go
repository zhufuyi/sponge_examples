...
func productMiddlewares(c *middlewareConfig) {
	...
	//c.setSinglePath("POST", "/api/v1/product", middleware.Auth())
	//c.setSinglePath("DELETE", "/api/v1/product/:id", middleware.Auth())
	//c.setSinglePath("PUT", "/api/v1/product/:id", middleware.Auth())
	//c.setSinglePath("GET", "/api/v1/product/:id", middleware.Auth())
	//c.setSinglePath("POST", "/api/v1/product/list", middleware.Auth())
}
