...
func (r *flashSaleRouter) register() {
	...
	r.iRouter.Handle("GET", "/api/v1/redisQueryPrepared", r.withMiddleware("GET", "/api/v1/redisQueryPrepared", r.RedisQueryPrepared_0)...)
	r.iRouter.Handle("POST", "/api/v1/SendSubmitOrderNotify", r.withMiddleware("POST", "/api/v1/SendSubmitOrderNotify", r.SendSubmitOrderNotify_0)...)
