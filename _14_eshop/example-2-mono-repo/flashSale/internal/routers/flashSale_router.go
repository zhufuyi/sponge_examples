...
import (
	...
	"eshop/flashSale/internal/handler"
)
...
func flashSaleMiddlewares(c *middlewareConfig) {
	...
	//c.setSinglePath("GET", "/api/v1/redisQueryPrepared", middleware.Auth())    // RedisQueryPrepared 反查redis数据
	//c.setSinglePath("POST", "/api/v1/SendSubmitOrderNotify", middleware.Auth())    // SendSubmitOrderNotify 发送提交订单通知
}
