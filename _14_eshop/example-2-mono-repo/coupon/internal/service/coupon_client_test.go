...
func Test_service_coupon_methods(t *testing.T) {
	...
	tests := []struct {
...

		{
			...
			fn: func() (interface{}, error) {
				...
				req := &couponV1.CreateCouponRequest{
					UserID: 0, // 用户id
					Amount: 0, // 优惠券金额(分)
					Status: 0, // 是否使用, 1:未使用, 2:已使用, 3:已过期
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &couponV1.DeleteCouponByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &couponV1.UpdateCouponByIDRequest{
					Id:     0,
					UserID: 0, // 用户id
					Amount: 0, // 优惠券金额(分)
					Status: 0, // 是否使用, 1:未使用, 2:已使用, 3:已过期
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &couponV1.GetCouponByIDRequest{
					Id: 0,
				}
...

		{
			...
			fn: func() (interface{}, error) {
				// todo type in the parameters before testing
				req := &couponV1.ListCouponRequest{
					Params: nil,
				}
...
func Test_service_coupon_benchmark(t *testing.T) {
	...
	tests := []struct {
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &couponV1.CreateCouponRequest{
					UserID: 0, // 用户id
					Amount: 0, // 优惠券金额(分)
					Status: 0, // 是否使用, 1:未使用, 2:已使用, 3:已过期
				}
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &couponV1.DeleteCouponByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &couponV1.UpdateCouponByIDRequest{
					Id:     0,
					UserID: 0, // 用户id
					Amount: 0, // 优惠券金额(分)
					Status: 0, // 是否使用, 1:未使用, 2:已使用, 3:已过期
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &couponV1.GetCouponByIDRequest{
					Id: 0,
				}
				total := 1000 // total number of requests
...

		{
			...
			fn: func() error {
				// todo type in the parameters before benchmark testing
				message := &couponV1.ListCouponRequest{
					Params: nil,
				}
				total := 1000 // total number of requests
