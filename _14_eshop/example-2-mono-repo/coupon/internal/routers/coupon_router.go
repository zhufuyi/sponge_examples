...
func couponMiddlewares(c *middlewareConfig) {
	...
	//c.setSinglePath("POST", "/api/v1/coupon/use", middleware.Auth())    // CouponUse 使用优惠券
	//c.setSinglePath("POST", "/api/v1/coupon/useRevert", middleware.Auth())    // CouponUseRevert 补偿优惠券
