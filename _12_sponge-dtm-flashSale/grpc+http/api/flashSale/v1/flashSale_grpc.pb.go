...
const (
	FlashSale_SetProductStock_FullMethodName       = "/api.flashSale.v1.flashSale/SetProductStock"
...
type FlashSaleClient interface {
	// 设置库存数量
	SetProductStock(ctx context.Context, in *SetProductStockRequest, opts ...grpc.CallOption) (*SetProductStockReply, error)
	// 秒杀抢购
...
func (c *flashSaleClient) SetProductStock(ctx context.Context, in *SetProductStockRequest, opts ...grpc.CallOption) (*SetProductStockReply, error) {
	out := new(SetProductStockReply)
	err := c.cc.Invoke(ctx, FlashSale_SetProductStock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FlashSaleServer interface {
	// 设置库存数量
	SetProductStock(context.Context, *SetProductStockRequest) (*SetProductStockReply, error)
	// 秒杀抢购
...
func (UnimplementedFlashSaleServer) SetProductStock(context.Context, *SetProductStockRequest) (*SetProductStockReply, error) {
...
func _FlashSale_SetProductStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetProductStockRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FlashSaleServer).SetProductStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FlashSale_SetProductStock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FlashSaleServer).SetProductStock(ctx, req.(*SetProductStockRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _FlashSale_SetProductStock_Handler,
		},
		{
