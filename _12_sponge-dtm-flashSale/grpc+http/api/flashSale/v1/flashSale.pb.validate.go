...
// Validate checks the field values on SetProductStockRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SetProductStockRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SetProductStockRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SetProductStockRequestMultiError, or nil if none found.
func (m *SetProductStockRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SetProductStockRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetProductID() <= 0 {
		err := SetProductStockRequestValidationError{
			field:  "ProductID",
	...
	if len(errors) > 0 {
		return SetProductStockRequestMultiError(errors)
	}

	return nil
}

// SetProductStockRequestMultiError is an error wrapping multiple validation
// errors returned by SetProductStockRequest.ValidateAll() if the designated
// constraints aren't met.
type SetProductStockRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SetProductStockRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m SetProductStockRequestMultiError) AllErrors() []error { return m }

// SetProductStockRequestValidationError is the validation error returned by
// SetProductStockRequest.Validate if the designated constraints aren't met.
type SetProductStockRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e SetProductStockRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SetProductStockRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SetProductStockRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SetProductStockRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SetProductStockRequestValidationError) ErrorName() string {
	return "SetProductStockRequestValidationError"
}

// Error satisfies the builtin error interface
func (e SetProductStockRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sSetProductStockRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SetProductStockRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SetProductStockRequestValidationError{}

// Validate checks the field values on SetProductStockReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SetProductStockReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SetProductStockReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SetProductStockReplyMultiError, or nil if none found.
func (m *SetProductStockReply) ValidateAll() error {
	return m.validate(true)
}

func (m *SetProductStockReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SetProductStockReplyMultiError(errors)
	}

	return nil
}

// SetProductStockReplyMultiError is an error wrapping multiple validation
// errors returned by SetProductStockReply.ValidateAll() if the designated
// constraints aren't met.
type SetProductStockReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SetProductStockReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SetProductStockReplyMultiError) AllErrors() []error { return m }

// SetProductStockReplyValidationError is the validation error returned by
// SetProductStockReply.Validate if the designated constraints aren't met.
type SetProductStockReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SetProductStockReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SetProductStockReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SetProductStockReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SetProductStockReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SetProductStockReplyValidationError) ErrorName() string {
	return "SetProductStockReplyValidationError"
}

// Error satisfies the builtin error interface
func (e SetProductStockReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSetProductStockReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SetProductStockReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SetProductStockReplyValidationError{}
