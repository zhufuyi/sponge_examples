...
type FlashSaleLogicer interface {
	...
	RedisQueryPrepared(ctx context.Context, req *RedisQueryPreparedRequest) (*RedisQueryPreparedReply, error)
...
func (r *flashSaleRouter) register() {
	...
	r.iRouter.Handle("GET", "/api/v1/flashSale/redisQueryPrepared", r.withMiddleware("GET", "/api/v1/flashSale/redisQueryPrepared", r.RedisQueryPrepared_0)...)
	r.iRouter.Handle("POST", "/api/v1/flashSale/sendSubmitOrderNotify", r.withMiddleware("POST", "/api/v1/flashSale/sendSubmitOrderNotify", r.SendSubmitOrderNotify_0)...)
...
func (r *flashSaleRouter) RedisQueryPrepared_0(c *gin.Context) {
	req := &RedisQueryPreparedRequest{}
	var err error
	...
	out, err := r.iLogic.RedisQueryPrepared(ctx, req)
	if err != nil {
		if errors.Is(err, errcode.SkipResponse) {
			return
		}
...
func (r *flashSaleRouter) SendSubmitOrderNotify_0(c *gin.Context) {
