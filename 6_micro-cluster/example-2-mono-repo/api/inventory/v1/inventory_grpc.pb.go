...
const (
	Inventory_GetByID_FullMethodName = "/api.inventory.v1.Inventory/GetByID"
)
...
func (c *inventoryClient) GetByID(ctx context.Context, in *GetByIDRequest, opts ...grpc.CallOption) (*GetByIDReply, error) {
	...
	err := c.cc.Invoke(ctx, Inventory_GetByID_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Inventory_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Inventory_GetByID_FullMethodName,
	}
